...
EXPECTED_TOOL_SIGNATURES = [
    ...
    "trading_macd(symbol, limit, fast_period=12, slow_period=26, signal_period=9, offset=0, period_type='1d', start_date=None, end_date=None, response_format='markdown'): return MACD, signal, histogram values.",
    "trading_volume(symbol, limit, offset=0, period_type='1d', start_date=None, end_date=None, response_format='markdown'): return volume, amount, turnover_rate values.",
    "trading_rsi(symbol, limit, period=14, offset=0, period_type='1d', start_date=None, end_date=None, response_format='markdown'): return RSI values.",
    "trading_ma(symbol, limit, period=20, ma_type='sma', offset=0, period_type='1d', start_date=None, end_date=None, response_format='markdown'): return moving average values.",
    "trading_fund_flow_individual_em(symbol, limit=200, offset=0, start_date=None, end_date=None, response_format='markdown'): return Eastmoney individual stock fund-flow records.",
    "trading_fund_flow_individual_rank_em(indicator='5日', limit=200, offset=0, response_format='markdown'): return Eastmoney individual stock fund-flow rankings.",
    "trading_fund_flow_sector_rank_em(indicator='今日', sector_type='行业资金流', limit=200, offset=0, response_format='markdown'): return Eastmoney sector fund-flow rankings.",
    "trading_fund_flow_sector_summary_em(symbol, indicator='今日', limit=200, offset=0, response_format='markdown'): return Eastmoney board constituent fund-flow records.",
    "trading_fundamental_cn_indicators(symbol, indicator='按报告期', limit=200, offset=0, start_date=None, end_date=None, response_format='markdown'): return A-share fundamental indicators (raw records).",
    "trading_fundamental_us_report(stock, symbol='资产负债表', indicator='年报', limit=200, offset=0, start_date=None, end_date=None, response_format='markdown'): return US financial statements (raw records).",
